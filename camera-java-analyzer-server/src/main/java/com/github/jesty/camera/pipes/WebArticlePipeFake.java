...
import com.github.jesty.camera.textclassification.FakeTextClassificationService;
...
@Component
public class WebArticlePipeFake extends AbstractPipe {
	...
	public void init() {
		this.add(
				...
				new StopWordsAction(),
				new TextClassificationAction(new FakeTextClassificationService(), 60),
				new StoreDocument(),
				new GeneratesFacets());
		super.init();
	}
